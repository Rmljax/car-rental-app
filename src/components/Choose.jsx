          ...
          <div className="choose__content">
            <div className="choose__text">
              ...
              <h2 className="choose__text__title">
                Bet valued deals youwill ever find
              </h2>
              <p className="choose__text__para">
                Discover the best deals you'll ever find with our unbeatable
                offers. We're dedicated to providing you with the best value for
                your money, so you can enjoy top-quality services and prouducts
                without breaking the bank. Our deals are designed to give you
                the ultimate renting experience, so you don't miss out on your
                chane to save big.
              </p>
              <Link to="/models">
